...
pushd /srv/ontoportal/bioportal_web_ui/current
  ...
  cp config/credentials/appliance.* /srv/ontoportal/appliance_config/bioportal_web_ui/config/credentials/ || exit 1
popd
